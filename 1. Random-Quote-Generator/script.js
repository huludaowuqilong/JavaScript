// Read the body of index.html

// Use addEventListener for the Generate Quote button in index.html

// Create a function that runs when the button is clicked and shows a random quote from the quotes object (below).
